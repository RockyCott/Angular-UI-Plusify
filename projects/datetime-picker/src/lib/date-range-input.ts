...
import {
  ...
  NgxPlusifyDateRangeInputParent,
  NgxPlusifyEndDate,
  NgxPlusifyStartDate,
...
export class NgxPlusifyDateRangeInput<D>
  implements
    ...
    NgxPlusifyDateRangeInputParent<D>,
    ...
    OnDestroy
{
  ...
  private _model: NgxPlusifyDateSelectionModel<NgxDateRange<D>> | undefined;
  ...
  private _registerModel(model: NgxPlusifyDateSelectionModel<NgxDateRange<D>>) {
    if (this._startInput) {
