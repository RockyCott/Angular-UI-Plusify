...
export const NGX_PLUSIFY_DATE_RANGE_SELECTION_STRATEGY = new InjectionToken<
  NgxPlusifyDateRangeSelectionStrategy<any>
>('NGX_PLUSIFY_DATE_RANGE_SELECTION_STRATEGY');

/** Object that can be provided in order to customize the date range selection behavior. */
export interface NgxPlusifyDateRangeSelectionStrategy<D> {
  /**
...
export const NGX_PLUSIFY_CALENDAR_RANGE_STRATEGY_PROVIDER: FactoryProvider = {
  provide: NGX_PLUSIFY_DATE_RANGE_SELECTION_STRATEGY,
  deps: [
    [new Optional(), new SkipSelf(), NGX_PLUSIFY_DATE_RANGE_SELECTION_STRATEGY],
    NgxPlusifyDateAdapter,
  ],
  useFactory: NGX_PLUSIFY_CALENDAR_RANGE_STRATEGY_PROVIDER_FACTORY,
};
