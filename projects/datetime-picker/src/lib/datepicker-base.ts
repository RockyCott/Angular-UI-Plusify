...
import { ngxPlusifyDatepickerAnimations } from './datepicker-animations';
...
export const NGX_PLUSIFY_DATEPICKER_SCROLL_STRATEGY = new InjectionToken<() => ScrollStrategy>(
  'ngx-plusify-datepicker-scroll-strategy',
);
...
/** @docs-private */
export const NGX_PLUSIFY_DATEPICKER_SCROLL_STRATEGY_FACTORY_PROVIDER = {
  provide: NGX_PLUSIFY_DATEPICKER_SCROLL_STRATEGY,
  deps: [Overlay],
  ...
  implements OnInit, AfterViewInit, OnDestroy, CanColor
{
  ...
  _calendar = viewChild.required<NgxPlusifyCalendar<D>>(NgxPlusifyCalendar);

  /** Reference to the datepicker that created the overlay. */
  datepicker: NgxPlusifyDatepickerBase<any, S, D>;
  ...
  onTimeChanged(selectedDateWithTime: D | null) {
    const userEvent: NgxPlusifyCalendarUserEvent<D | null> = {
  ...
  _handleUserSelection(event: NgxPlusifyCalendarUserEvent<D | null>) {
  ...
  private _updateUserSelectionWithCalendarUserEvent(event: NgxPlusifyCalendarUserEvent<D | null>) {
  ...
  _handleUserDragDrop(event: NgxPlusifyCalendarUserEvent<NgxDateRange<D>>) {
...
export interface NgxPlusifyDatepickerControl<D> {
...
/** A datepicker that can be attached to a {@link NgxPlusifyDatepickerControl}. */
  ...
  implements NgxPlusifyDatepickerPanel<C, S, D>, OnDestroy, OnChanges
{
  ...
  readonly dateClass = input<NgxPlusifyCalendarCellClassFunction<D>>();
  ...
  private _componentRef: ComponentRef<NgxPlusifyDatepickerContent<S, D>> | null;
  ...
  /** Emits changed view */
  _viewChanged(view: NgxPlusifyCalendarView): void {
  ...
  protected _forwardContentValues(instance: NgxPlusifyDatepickerContent<S, D>) {
