...
export class NgxPlusifyMonthView<D> implements AfterContentInit, OnChanges, OnDestroy {
  ...
  _dateSelected(event: NgxPlusifyCalendarUserEvent<number>) {
   ...
   */
  _updateActiveDate(event: NgxPlusifyCalendarUserEvent<number>) {
